...
export default function Contact() {
    ...
    return(
            <div>
                <div id="contact">
                        <h2>Don't be shy, feel free to hit me up for anything!</h2> 
                    </div>
            <div id="contact-info">

                    <a href="https://www.linkedin.com/in/azeem-quadri/" className="fa-brands fa-linkedin-in" target="_blank" rel="noopener noreferrer" aria-hidden="true"></a>
